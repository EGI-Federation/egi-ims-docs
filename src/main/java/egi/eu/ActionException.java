...
public class ActionException extends RuntimeException {
    ...
    public ActionException(Throwable e, String id) {
        ...
        else if(GoogleJsonResponseException.class.isAssignableFrom(type)) {
            // Build from web exception
            var ge = (GoogleJsonResponseException)e;
            this.status = Response.Status.fromStatusCode(ge.getStatusCode());
        }
    }
