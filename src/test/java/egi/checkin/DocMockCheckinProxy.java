...
public class DocMockCheckinProxy implements QuarkusTestResourceLifecycleManager {

    private static final Logger log = Logger.getLogger(DocMockCheckinProxy.class);
    private static boolean logRequestBody = false;

    private DocMockCheckin mockCheckin;
    ...
    public Map<String, String> start() {
        ...
        //logRequestBody = true;
        mockCheckin = new DocMockCheckin(options()
                            .port(9091)
        ...
        mockCheckin.addMockServiceRequestListener(DocMockCheckinProxy::requestReceived);
    ...
    public void inject(TestInjector testInjector) {
        testInjector.injectIntoFields(mockCheckin,
                new TestInjector.AnnotatedAndMatchesType(InjectDocMockCheckin.class, DocMockCheckin.class));
    }
